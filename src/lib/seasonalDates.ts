...
const NICHE_DATES: Record<string, SeasonalDate[]> = {
  ...
  beleza: [
    { month: 1, day: 1, label: 'Janeiro Branco (autoestima e saúde mental)', daysBeforeAlert: 30 },
    { month: 1, day: 20, label: 'Dia do Cabeleireiro', daysBeforeAlert: 20 },
    { month: 2, day: 14, label: 'Carnaval (makes e looks)', daysBeforeAlert: 35 },
    ...
    { month: 5, day: 20, label: 'Dia do Esteticista', daysBeforeAlert: 25 },
    { month: 6, day: 12, label: 'Dia dos Namorados (looks)', daysBeforeAlert: 40 },
    { month: 7, day: 1, label: 'Dia da Dermatologista', daysBeforeAlert: 20 },
    { month: 8, day: 5, label: 'Dia Nacional da Saúde', daysBeforeAlert: 20 },
    { month: 9, day: 5, label: 'Dia da Amazônia (cosméticos naturais)', daysBeforeAlert: 20 },
    { month: 10, day: 1, label: 'Outubro Rosa', daysBeforeAlert: 40 },
    { month: 11, day: 1, label: 'Novembro Azul (estética masculina)', daysBeforeAlert: 30 },
    { month: 12, day: 25, label: 'Natal (presentes beauty)', daysBeforeAlert: 40 },
  ],
  educacao: [
